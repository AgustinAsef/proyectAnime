...
function GeneralHome() {
    ...
    const series = [  //esta es un array harcodeado para la muestra del sitio
    ...
    function changeDisplay() {  //funcion modificadora del estado que le da visibilidad del componente New Serie.
        if (show == "notShow") {
            setShow("show");
        } else {
            setShow("notShow");
    ...
    return (
        <>
            ...
            <div className="newSerieDivContainer p">
                ...
                <h3>
                    En esta pagina podras agregar las series que vas a ver y
                    checkear los capitulos que has visto para tenerlas al dia,
                    tal y como se muestra a continuecion.
                </h3>
                <div className="p">
            ...
            {series.map(
                (
                    serie //mapea el array de muestra
                ) => (
